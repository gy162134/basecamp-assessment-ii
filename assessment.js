...
var myFriends = ["Joe", "Rich", "Robert", "Kenneth"];
...
function evensOnly(arr) {
  var evensArray = myNumbers.filter(arr => arr%2==0);
  return evensArray;
}
...
var trueFriends = peopleIknow.filter(peopleIknow => peopleIknow.friend==true);
